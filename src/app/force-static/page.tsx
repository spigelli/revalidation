...
const CurrentTimeDifference = d(() => import('../CurrentTimeDifference'));
const HardNavigate = d(() => import('../HardNavigate'));
  ...
  return (
    <main className={styles.main}>
      ...
      <div className={styles.description}>
        <p>
          export const dynamic = &lsquo;force-static&lsquo;;
          export const revalidate = 5;
        </p>
      </div>
      ...
      <div className={styles.center}>
        <div className={styles.description}>
          ...
          <Link href="/force-static/dummy" className={styles.card}>
            Soft Navigate
          </Link>
        </div>
      </div>
