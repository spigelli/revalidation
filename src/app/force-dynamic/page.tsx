...
import CurrentTimeDifference from '../CurrentTimeDifference';
  ...
  return (
    <main className={styles.main}>
      ...
      <div className={styles.description}>
        <p>
          export const dynamic = &lsquo;force-dynamic&lsquo;;
          export const revalidate = 5;
        </p>
      </div>
      ...
      <div className={styles.center}>
        <div className={styles.description}>
          ...
          <Link href="/force-dynamic/dummy" className={styles.card}>
            Soft Navigate
          </Link>
          <Suspense fallback={<p>Loading...</p>}>
            {/* <HardNavigate /> */}
